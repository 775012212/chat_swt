    ...
    export default {
        ...
        methods   : {
            ...
            swtGenerate(option) {
                ...
                onload="console.log(LR_showminiDiv2);LR_showminiDiv=LR_showminiDiv2 = function(){};LR_Floaters[2].pms['html']='123';LR_showminiDiv_no=R_sidexists=2;"
                language="javascript" src="${option.js}"><\/script>`);
